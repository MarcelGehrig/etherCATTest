...
namespace etherCATInterface {
	...
	static constexpr int bytesPerPDOFrameTx = 34;	// eni.xml --> <EtherCATConfig> <Config> <ProcessImage> <Outputs> <ByteSize>
	static constexpr int bytesPerPDOFrameRx = 34;	// eni.xml --> <EtherCATConfig> <Config> <ProcessImage> <Inputs> <ByteSize>
